...
async def submit_question(request: QuestionRequest, api_key: str = Depends(verify_api_key)):
    ...
    keywords = {
        "ru": ["пасспорт", "паспорт", "заявление", "регистрация", "патент", "мигрант", "рвп", "внж", "гражданство", "миграционный", "зарегистрироваться"],
        "tj": ["паспорт", "дархост", "сабт", "бақайдгирӣ", "патент", "механик", "рвп", "внж", "гражданӣ", "мигратсионӣ", "ариза", "қайд гирифтан"],
